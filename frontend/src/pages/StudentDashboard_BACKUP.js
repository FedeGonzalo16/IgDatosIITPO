...
const StudentDashboard = ({ user, onLogout }) => {
  ...
  const renderContent = () => {
    ...
    if (activeMenu === 'inscribirse') {
      return <StudentEnrollment subjects={subjects} onBack={() => setActiveMenu('inicio')} />;
    }
    if (activeMenu === 'institucion') {
      return <ChangeInstitution user={user} onBack={() => setActiveMenu('inicio')} />;
    }
    if (activeMenu === 'convertir') {
      return <ConvertGrades subjects={subjects} onBack={() => setActiveMenu('inicio')} />;
    }
      ...
      <div className="dashboard-main">
        ...
        <div className="subjects-section">
          ...
          <div className="subjects-grid">
            {subjects.filter(s => s.estado === 'cursando').map(subject => (
        ...
        <div className="subjects-section">
          ...
          <div className="subjects-grid">
            {subjects.filter(s => s.estado === 'aprobada').map(subject => (
